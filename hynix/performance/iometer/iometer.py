...
try:
    ...
    for folders in gFolderInfos:   
        ...
        query = "insert into PERFORMANCE_FOLDER(FOLDER_NAME, SYSTEM, OPERATING_SYSTEM, VENDOR, PRODUCT_NAME, NAND_TECH, CELL_TYPE, CONTROLLER, FORM_FACTOR, CAPACITY, FIRMWARE, SLC_BUFFER, MEASURE_DT)"
        query += " values("
